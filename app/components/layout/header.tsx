    ...
    <header className="py-[14px] sm:py-[20px]">
      <div className="container container-pad">
        <div className="flex items-center justify-between gap-[18px] xl:gap-[24px]">
          ...
          >
             <button
              className="flex items-center justify-center xl:hidden h-[36px] min-w-[36px] max-w-[36px] sm:h-[50px] sm:min-w-[50px] sm:max-w-[50px] "
              type="button"
            ...
            >
              <div className="min-w-[19px] max-w-[19px] h-[14px] sm:min-w-[24px] sm:max-w-[24px] sm:h-[17px] md:min-w-[26px] md:max-w-[26px] md:h-[18px] justify-between flex flex-col gap-[3px] cursor-pointer">
                <span className="bg-primary w-full h-[2px] rounded-[10px]"></span>
                <span className="bg-primary w-full h-[2px] rounded-[10px]"></span>
                <span className="bg-primary w-full h-[2px] rounded-[10px]"></span>
              </div>
            </button>
          ...
          <div
            className={cn(
              "bg-green-200 z-50 transition-all xl:transition-none duration-150 xl:duration-[0] w-[320px] sm:w-[340px] xl:w-auto xl:bg-transparent xl:flex fixed top-0 h-[100vh] xl:h-auto  xl:relative",
          ...
          >
            ...
            <div className="block p-[16px] xl:hidden">
              <button
                type="button"
                className="block xl:hidden text-[14px] sm:text-[16px] 
                xl:text-[18px] leading-[22px] sm:leading-[26px] text-white font-manrope py-[8px] sm:py-[12px] px-[20px] sm:px-[26px] xl:py-[14px] xl:px-[34px] rounded-[999px] w-full bg-[#141414] font-semibold"
              >
                Sign Up
              </button>
            </div>
